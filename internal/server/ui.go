...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Estimate</title>
...
<div class="hdr"><h1><span>&#9670;</span> ESTIMATE</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main"><div class="tabs" id="tabs"><div class="tab active" onclick="switchTab('estimates')">Estimates</div><div class="tab" onclick="switchTab('line_items')">Line Items</div></div><div class="tab-content active" id="tab-estimates">
<div class="stats" id="stats-estimates"></div>
<div class="toolbar">
<input class="search" id="search-estimates" placeholder="Search..." oninput="renderRes('estimates')"><select class="filter-sel" id="filter-estimates-status" onchange="renderRes('estimates')"><option value="">All Status</option><option value="Draft">Draft</option><option value="Sent">Sent</option><option value="Accepted">Accepted</option><option value="Declined">Declined</option><option value="Expired">Expired</option></select></div>
<div class="count-label" id="count-estimates"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Client Name</th><th>Email</th><th>Phone</th><th>Title</th><th>Description</th><th>Total ($)</th><th>Valid Until</th><th>Status</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-estimates"></tbody></table></div></div><div class="tab-content" id="tab-line_items">
<div class="stats" id="stats-line_items"></div>
<div class="toolbar">
<input class="search" id="search-line_items" placeholder="Search..." oninput="renderRes('line_items')"></div>
<div class="count-label" id="count-line_items"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Estimate ID</th><th>Description</th><th>Quantity</th><th>Unit Price ($)</th><th>Total ($)</th><th></th></tr></thead><tbody id="tbody-line_items"></tbody></table></div></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="estimates";var resCfg={"estimates":{d:"Estimates",f:[{n:"client_name",l:"Client Name",t:"text",r:true,o:[]},{n:"client_email",l:"Email",t:"email",r:false,o:[]},{n:"client_phone",l:"Phone",t:"phone",r:false,o:[]},{n:"title",l:"Title",t:"text",r:true,o:[]},{n:"description",l:"Description",t:"textarea",r:false,o:[]},{n:"total",l:"Total ($)",t:"number",r:false,o:[]},{n:"valid_until",l:"Valid Until",t:"date",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Draft","Sent","Accepted","Declined","Expired"]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},"line_items":{d:"Line Items",f:[{n:"estimate_id",l:"Estimate ID",t:"text",r:true,o:[]},{n:"description",l:"Description",t:"text",r:true,o:[]},{n:"quantity",l:"Quantity",t:"number",r:false,o:[]},{n:"unit_price",l:"Unit Price ($)",t:"number",r:false,o:[]},{n:"total",l:"Total ($)",t:"number",r:false,o:[]}]},};
...
['estimates','line_items'].forEach(function(r){renderRes(r)});
}
}else{
